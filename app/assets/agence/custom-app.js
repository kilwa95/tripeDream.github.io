...
$(document).ready(function () {
    collectionHolderFx("programmes");
    collectionHolderFx("tarifs");
});

function collectionHolderFx(id) {
    ...
    var $addNewItem = $('<a href="#" class="btn btn-info">Ajouter</a>');
...
function addRemoveButton ($panel) {
    ...
    var $removeButton = $('<a href="#" class="btn btn-danger">Retirer</a>');
